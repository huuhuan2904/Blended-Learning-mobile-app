...
import 'package:flutter_application_1/doctor/quanlydangnhap/signup_screen.dart';
...
import '../fragments/overview_app_screenD.dart';
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (resBodyOfLogin['success'] == true) {
          ...
          Doctor doctorInfo = Doctor.fromJson(resBodyOfLogin["doctorData"]);

          //Save user info to local storage using Shared Prefrences
          await RememberDoctorPrefs.storeDoctorInfo(doctorInfo);
